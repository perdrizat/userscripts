...
A collection of Tampermonkey userscripts for improving various websites.

## Installation

1. Install [Tampermonkey](https://www.tampermonkey.net/) for your browser.
2. Click the install link for any script below — Tampermonkey will open and prompt you to install it.
